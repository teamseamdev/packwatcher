...
- User-triggered Watchlist retailer discovery is constrained to the configured shopping-search provider. Direct retailer HTML imports remain admin/config-only so user searches do not scrape Walmart, Target, or GameStop pages.
