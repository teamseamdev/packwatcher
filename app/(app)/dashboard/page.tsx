  ...
  return (
    <div className="space-y-8">
      <div className="pw-hero p-5 sm:p-6">
        <p className="pw-hud text-xs font-black">Dashboard</p>
        ...
        <div className="pw-panel rounded-lg border border-white/10 bg-white/[0.04] p-5">
          ...
          <div className="mt-4 space-y-3">
            {notifications?.length ? notifications.map((item) => (
              <div key={item.id} className="pw-stat-tile rounded-lg p-3">
        ...
        <div className="pw-panel rounded-lg border border-white/10 bg-white/[0.04] p-5">
          ...
          <div className="mt-4 space-y-3">
            {checks?.length ? checks.map((item) => (
              <div key={item.id} className="pw-stat-tile rounded-lg p-3 text-sm">
